    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(InverseAngleUnit), (int)InverseAngleUnit.InverseDegree, new string[]{"1/°", "1/deg"}),
                ("ru-RU", typeof(InverseAngleUnit), (int)InverseAngleUnit.InverseDegree, new string[]{"°"}),
                ("en-US", typeof(InverseAngleUnit), (int)InverseAngleUnit.InverseRadian, new string[]{"1/rad"}),
                ("ru-RU", typeof(InverseAngleUnit), (int)InverseAngleUnit.InverseRadian, new string[]{"рад"}),
