...
namespace UnitsNet
{
    ...
    public static partial class Quantity
    {
        ...
        public static readonly IDictionary<string, QuantityInfo> ByName = new Dictionary<string, QuantityInfo>
        {
            ...
            { "InverseAngle", InverseAngle.Info },
        ...
        internal static readonly IDictionary<string, QuantityType> QuantityTypeByName = new Dictionary<string, QuantityType>
        {
            ...
            { "InverseAngle", QuantityType.InverseAngle },
        ...
        public static IQuantity FromQuantityType(QuantityType quantityType, QuantityValue value)
        {
            switch(quantityType)
            {
                ...
                case QuantityType.InverseAngle:
                    return InverseAngle.From(value, InverseAngle.BaseUnit);
        ...
        public static bool TryFrom(QuantityValue value, Enum unit, out IQuantity? quantity)
        {
            switch (unit)
            {
                ...
                case InformationUnit informationUnit:
                    ...
                    return true;
                case InverseAngleUnit inverseAngleUnit:
                    quantity = InverseAngle.From(value, inverseAngleUnit);
                    return true;
        ...
        public static bool TryParse(IFormatProvider? formatProvider, Type quantityType, string quantityString, out IQuantity? quantity)
        {
            ...
            switch(quantityType)
            {
                ...
                case Type _ when quantityType == typeof(InverseAngle):
                    return parser.TryParse<InverseAngle, InverseAngleUnit>(quantityString, formatProvider, InverseAngle.From, out quantity);
