...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.HourPerFoot, q => q.ToUnit(InverseSpeedUnit.HourPerFoot));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.HourPerFoot, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.HourPerInch, q => q.ToUnit(InverseSpeedUnit.HourPerInch));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.HourPerInch, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.HourPerMeter, q => q.ToUnit(InverseSpeedUnit.HourPerMeter));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.HourPerMeter, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.HourPerMile, q => q.ToUnit(InverseSpeedUnit.HourPerMile));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.HourPerMile, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.InverseKnot, q => q.ToUnit(InverseSpeedUnit.InverseKnot));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.InverseKnot, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.MinutePerFoot, q => q.ToUnit(InverseSpeedUnit.MinutePerFoot));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.MinutePerFoot, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.MinutePerInch, q => q.ToUnit(InverseSpeedUnit.MinutePerInch));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.MinutePerInch, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.MinutePerMeter, q => q.ToUnit(InverseSpeedUnit.MinutePerMeter));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.MinutePerMeter, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.SecondPerFoot, q => q.ToUnit(InverseSpeedUnit.SecondPerFoot));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.SecondPerFoot, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeedUnit.SecondPerInch, q => q.ToUnit(InverseSpeedUnit.SecondPerInch));
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeedUnit.SecondPerInch, InverseSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<InverseSpeed>(InverseSpeed.BaseUnit, InverseSpeed.BaseUnit, q => q);
            ...
            unitConverter.SetConversionFunction<SpecificFuelConsumption>(SpecificFuelConsumption.BaseUnit, SpecificFuelConsumptionUnit.KilogramPerKiloNewtonSecond, q => q.ToUnit(SpecificFuelConsumptionUnit.KilogramPerKiloNewtonSecond));
            unitConverter.SetConversionFunction<SpecificFuelConsumption>(SpecificFuelConsumptionUnit.KilogramPerKiloNewtonSecond, SpecificFuelConsumption.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<SpecificFuelConsumption>(SpecificFuelConsumption.BaseUnit, SpecificFuelConsumptionUnit.PoundMassPerPoundForceHour, q => q.ToUnit(SpecificFuelConsumptionUnit.PoundMassPerPoundForceHour));
            unitConverter.SetConversionFunction<SpecificFuelConsumption>(SpecificFuelConsumptionUnit.PoundMassPerPoundForceHour, SpecificFuelConsumption.BaseUnit, q => q.ToBaseUnit());
