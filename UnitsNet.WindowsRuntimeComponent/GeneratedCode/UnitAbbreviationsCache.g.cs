    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.HourPerFoot, new string[]{"h/ft"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.HourPerInch, new string[]{"h/in"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.HourPerMeter, new string[]{"h/m"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.HourPerMile, new string[]{"h/mi"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.InverseKnot, new string[]{"1/knot"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.MinutePerFoot, new string[]{"min/ft"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.MinutePerInch, new string[]{"min/in"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.MinutePerMeter, new string[]{"min/m"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.SecondPerFoot, new string[]{"s/ft"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.SecondPerInch, new string[]{"s/in"}),
                ("en-US", typeof(InverseSpeedUnit), (int)InverseSpeedUnit.SecondPerMeter, new string[]{"s/m"}),
                ...
                ("en-US", typeof(SpecificFuelConsumptionUnit), (int)SpecificFuelConsumptionUnit.GramPerKiloNewtonSecond, new string[]{"g/(kN�s)"}),
                ("en-US", typeof(SpecificFuelConsumptionUnit), (int)SpecificFuelConsumptionUnit.KilogramPerKilogramForceHour, new string[]{"kg/(kgf�h)"}),
                ("en-US", typeof(SpecificFuelConsumptionUnit), (int)SpecificFuelConsumptionUnit.KilogramPerKiloNewtonSecond, new string[]{"kg/(kN�s)"}),
                ("en-US", typeof(SpecificFuelConsumptionUnit), (int)SpecificFuelConsumptionUnit.PoundMassPerPoundForceHour, new string[]{"lb/(lbf�h)"}),
